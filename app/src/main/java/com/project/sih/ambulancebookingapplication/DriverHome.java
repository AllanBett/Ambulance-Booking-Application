...
public class DriverHome extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initialising reg token and then finally storing other information(if needed,
        // see the function storeData for a detail on this)
        fetchLocation();
        InitToken();
        storeData();
    ...
    private Marker addMarker(GoogleMap googleMap, LatLng latLng) {
        Marker marker = googleMap.addMarker(new MarkerOptions().title("Current Location...").position(latLng));
...
//            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            showSnackbar("Error Logging out! Try again");
            //Toast.makeText(DriverHome.this, "Try checking your internet connection", Toast.LENGTH_LONG).show();
    }
