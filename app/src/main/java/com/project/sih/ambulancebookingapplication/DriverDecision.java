...
public class DriverDecision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String senderPhoneNumber = mappingDetails[6],
                receiverPhoneNumber = mappingDetails[7];
        ...
        URL = "https://www.google.com/maps/dir/?api=1&travelmode=driving&dir_action=navigate&destination="
                + destination + "&origin=" + origin;

        acceptButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageSender.getInstance().sendMessage(targetRegToken,
                        "The driver has accepted your requested, will be arriving soon " +
                        "with the ambulance.", "Request Accepted!," + "Rider," + "null,"
                                + "null," + "null," + "null," + "null," +
